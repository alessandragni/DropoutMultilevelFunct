...
PLOTLambda = function(hazard, selected_centres, type, add_hat=FALSE){
  ...
  if(add_hat == FALSE)
    ggsave(paste0("Plots/Simulation/", type, ".pdf"), width = 8, height = 6, units = "in", device = "pdf")
  else
    ggsave(paste0("Plots/Simulation/", type, "POST.pdf"), width = 8, height = 6, units = "in", device = "pdf")
}
...
PlotEigenFunMFPCA = function(plot_data, level, post=FALSE){
  ...
  print(PLOT)
  if(post == FALSE)
    ggsave(paste0("Plots/Simulation/EigenFunL",level,".pdf"), width = 8, height = 4, units = "in", device = "pdf")
  if(post == TRUE)
    ggsave(paste0("Plots/Simulation/EigenFunL",level,"POST.pdf"), width = 8, height = 4, units = "in", device = "pdf")
}
...
PlotCompMFPCA = function(plot_data, level = 1, component = 1, post = FALSE, coeff){
  ...
  print(PLOT)
  if(post == FALSE)
    ggsave(paste0("Plots/Simulation/C",component,"L",level,".pdf"), width = 8, height = 4, units = "in", device = "pdf")
  if(post == TRUE)
    ggsave(paste0("Plots/Simulation/C",component,"L",level,"POST.pdf"), width = 8, height = 4, units = "in", device = "pdf")
...
plot_Lambda0 <- function(list_L0){
  ...
  print(PLOT)
  ggsave("Plots/Simulation/Baseline.pdf", width = 8, height = 6, units = "in", device = "pdf")
}
