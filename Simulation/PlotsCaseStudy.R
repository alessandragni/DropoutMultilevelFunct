...
PLOTLambda = function(hazard, type, add_hat=FALSE){
  ...
  if(add_hat == FALSE)
    ...
    # ggsave(paste0("Plots/CaseStudy/CS_", type, ".pdf"), width = 6, height = 7, units = "in", device = "pdf")
  else
    ggsave(paste0("Plots/CaseStudy/CS_", type, "POST.pdf"), width = 8, height = 6, units = "in", device = "pdf")
    # ggsave(paste0("Plots/CaseStudy/CS_", type, "POST.pdf"), width = 6, height = 7, units = "in", device = "pdf")
}
...
PlotCompMFPCA = function(plot_data, level = 1, component = 1, post = FALSE, coeff){
  ...
  if(post == FALSE)
    ...
    # ggsave(paste0("Plots/CaseStudy/CS_",component,"L",level,".pdf"), width = 6, height = 7, units = "in", device = "pdf")
  if(post == TRUE)
    ggsave(paste0("Plots/CaseStudy/CS_",component,"L",level,"POST.pdf"), width = 8, height = 4, units = "in", device = "pdf")
    # ggsave(paste0("Plots/CaseStudy/CS_",component,"L",level,"POST.pdf"), width = 6, height = 7, units = "in", device = "pdf")
